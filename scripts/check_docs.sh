...
require_text "docs/standard/README.md" "truth-state.md"
require_text "docs/standard/truth-state.md" "registered != adopted"
require_text "docs/standard/truth-state.md" "dry_run_ready != executed"
require_text "docs/standard/truth-state.md" "artifact_exists != usable"
require_text "docs/standard/truth-state.md" "GOWORK=off XLIB_CONTEXT=ci_pull_request make governance-check"
...
require_text ".github/workflows/ci.yml" "make governance-check"
require_text ".github/workflows/ci.yml" "make p1-governance-check"
require_text ".github/workflows/ci.yml" "make p2-runtime-check"
