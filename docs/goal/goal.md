...
| P1-008 | Downstream Registry                         | downstream        | C2         | .agent/downstream-registry.yaml; docs/standard/downstream-registry.md; internal/goalcli/downstream/\*\*                                                                                                                                          | goalcli downstream-registry                                               | 登记 kernel/configx/observex/testkitx/postgresx/redisx/kafkax/natsx/taosx/ossx/clickhousex     |
...
| P1-013 | Supply Chain Security Baseline              | security          | C3         | .agent/supply-chain-security.yaml; docs/standard/supply-chain-security.md; .github/workflows/ci.yml                                                                                                                                               | goalcli supply-chain; make security; make lint                            | optional govulncheck/golangci-lint/action pinning/least privilege/go.mod drift                          |
