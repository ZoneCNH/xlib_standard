...
| P1-016 | AutoResearch Trigger and Record Protocol    | autoresearch      | C2         | .agent/policies/autoresearch.yaml; docs/standard/autoresearch.md; .agent/research-record-template.md                                                                                                                                                       | goalcli autoresearch                                                      | 外部链接/工具链/依赖/不确定事实触发 research record 和 decision impact                         |
