...
本文定义 `xlib-standard -> L0 -> L1 -> L2 -> L3` 的规则、管理边界、约束限制和后续更新迭代流程。若本文与更高权威文件冲突，以 `CONSTITUTION.md`、`docs/standard/module-boundary.md`、`.agent/harness/harness.yaml` 和 release Evidence gate 为准。决策背景见 [ADR-20260604-001](../adr/ADR-20260604-001-layer-governance.md)。
