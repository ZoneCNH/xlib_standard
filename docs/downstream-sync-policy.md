...
`Context Runtime v4.0 profile` 是 context profile / registry bridge 的同步条目名称，不改写 Full Goal Runtime v3.1 的 `.agent/` 工件版本，也不替代 [docs/goal/goal.md](goal/goal.md) v2.9.3 Complete 的治理主基线。
