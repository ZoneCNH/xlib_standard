...
func Compute(threshold float64) Report {
	...
	dimensions := []Dimension{
		...
		textDimension("retrospective_template", 1, ".agent/docs/retrospective-template.md", []string{"Score", "Gate", "Patch"}, "retrospectives capture gate score and patch rationale"),
		textDimension("release_template", 1, ".agent/release/release-template.md", []string{"go run ./cmd/goalcli score --min 9.8", "CI artifact", "score"}, "release template requires score and artifact evidence"),
	}
